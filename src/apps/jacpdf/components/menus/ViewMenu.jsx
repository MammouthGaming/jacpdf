...
export default function ViewMenu({ onPresentation, onRotateCW, onRotateCCW, onTwoPages, twoPages, onScreenMask, screenMask, onClose }) {
  ...
  return (
    <>
      ...
      <div className="vm-menu">
        ...
        <button className={`vm-item ${screenMask ? 'vm-item-active' : ''}`} onClick={() => handle(onScreenMask)}>
          <span className="vm-item-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <rect x="2" y="3" width="20" height="14" rx="2"/>
