// Store des groupes d'onglets — collection NOMMÉE d'onglets PDF que
// l'utilisateur peut sauvegarder pour rouvrir tous d'un coup depuis
// la page d'Accueil (façon « sessions » de Chrome).
//
...
// table `tab_groups` (les bytes des PDFs iront dans Supabase Storage,
// pas en colonne JSON). L'API publique (getAll / create / remove /
